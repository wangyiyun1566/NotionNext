...
const CONFIG = {
  ...
  STARTER_HERO_TITLE_1: '高档门窗品牌', // 英雄区文字
  STARTER_HERO_TITLE_2: '为您建设理想家', // 英雄区文字
  // 英雄区两个按钮，如果TEXT留空则隐藏按钮
  STARTER_HERO_BUTTON_1_TEXT: '开始体验', // 英雄区按钮
  STARTER_HERO_BUTTON_1_URL: '', // 英雄区按钮
  STARTER_HERO_BUTTON_2_TEXT: '立即联系我们', // 英雄区按钮
  ...
  STARTER_CONTACT_TEXT: '',
  STARTER_CONTACT_LOCATION_TITLE: '我们的位置',
  STARTER_CONTACT_LOCATION_TEXT: '中国，娄底，双峰',
  STARTER_CONTACT_EMAIL_TITLE: '我们如何帮助您？',
  STARTER_CONTACT_EMAIL_TEXT: 'jpmc@163.com',
  ...
  STARTER_FOOTER_SLOGAN: '为您打造宜居门窗体验。',
